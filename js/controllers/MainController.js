app.controller("MainController", function($scope) {
  ...
  $scope.numberOfExcos = [2,3,4,5,6,7,8,9];
  function Exco(name){
    this.name = name;
    this.avail = {};
  ...
  $scope.confirmNumberOfExco = function(){
    $scope.selectExcoNumber = false;
    $scope.addExco = true;
  ...
  //return the key with the largest value   
    ...
    $scope.shiftArrangement = function(){
      ...
      while(nextTimeslot != null){
        ...
        while($scope.assignment[nextTimeslot].size < min([$scope.maxExcoNumber,$scope.timeslot[nextTimeslot]])){
